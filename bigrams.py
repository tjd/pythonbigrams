...
#
# The idea is to take some text (usually lots and lots of it!) and count how
# many times each bigram occurs. Then, for instance, if someone types the word
# 'I', we can suggest as the next word the second word in the most frequent
# bigram starting with 'I'.
#
...
#
# Shows most popular suggestions (and their counts) for word w. counts is a
# sorted list of (count, bigram) pairs
#
...
#
# Returns the word that appears most frequently after w. counts is a sorted
# list of (count, bigram) pairs
#
...
#
# Returns sequence of most likely words beginning with start_word. Can result
# in some amusing sentences. counts is a sorted list of (count, bigram) pairs
#
